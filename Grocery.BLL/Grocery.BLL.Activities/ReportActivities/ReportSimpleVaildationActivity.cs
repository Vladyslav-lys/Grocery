...
{
    public class ReportSimpleVaildationActivity : IValidationActivity<GetReportSimpleRequest>
    {
        private IReportValidationRule reportValidationRule;

        public ReportSimpleVaildationActivity(IReportValidationRule reportValidationRule)
        {
