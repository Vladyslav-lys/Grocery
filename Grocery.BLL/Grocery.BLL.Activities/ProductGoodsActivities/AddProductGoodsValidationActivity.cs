...
{
    public class AddProductGoodsValidationActivity : IValidationActivity<AddProductGoodsRequest>
    {
        private IArrivedGoodsValidationRule arrivedGoodsValidationRule;
        private IProductValidationRule productValidationRule;

        public AddProductGoodsValidationActivity(IArrivedGoodsValidationRule arrivedGoodsValidationRule, IProductValidationRule productValidationRule)
        {
            this.arrivedGoodsValidationRule = arrivedGoodsValidationRule;
            this.productValidationRule = productValidationRule;
        }

        public void Validate(AddProductGoodsRequest request)
        {
